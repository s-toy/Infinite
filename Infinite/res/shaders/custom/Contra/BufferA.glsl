...
const float KEY_A    				= 65.5 / 512.0;
const float KEY_Q    				= 81.5 / 512.0;
const float KEY_S    				= 83.5 / 512.0;
const float KEY_W    				= 87.5 / 512.0;
const float KEY_LEFT  				= 263.5 / 512.0;
const float KEY_UP    				= 265.5 / 512.0;
const float KEY_RIGHT 				= 262.5 / 512.0;
const float KEY_DOWN  				= 264.5 / 512.0;
